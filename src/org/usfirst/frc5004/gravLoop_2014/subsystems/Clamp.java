...
public class Clamp extends Subsystem {
    ...
    DoubleSolenoid cPiston = RobotMap.clampCPiston;
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    
    public void open(){
        cPiston.set(DoubleSolenoid.Value.kForward);
    }
    public void close(){
        cPiston.set(DoubleSolenoid.Value.kReverse);
    }
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        setDefaultCommand(new ClampOpen());
    }
}
